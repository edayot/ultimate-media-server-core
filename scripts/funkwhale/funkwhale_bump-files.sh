...
(cd /home/erwan/new_opt/docker-funkwhale/; docker-compose run --name="$IDENTIFIER" api python manage.py import_files "/srv/funkwhale/data/music/**/*.mp3" --recursive --noinput --in-place)
